...
const Results: SearchResultsInterface = {
  highlights: [
    {
      title: "Pop & Art",
    ...
    },
    {
      ...
      logo: "http://s.glbimg.com/bu/i/fc/5fb2e18d-a47f-4bb8-9a7e-b66871cf53c0.png",
      queries: ["eleições", "política", "dilma", "aécio", "apuração"],
    },
    {
      title: "Neymar",
      ...
      queries: ["futebol", "neymar", "barcelona", "brasil"],
    },
    {
      title: "iPhone",
      ...
      queries: ["iphone", "celular", "apple", "smartphone"],
    },
  ],
  suggestions: [
    "futebol brasileiro",
